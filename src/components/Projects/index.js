    ...
    <Container id="projects">
      <Wrapper>
        ...
        <ToggleButtonGroup >
          ...
          <Divider />
          {toggle === 'web app' ?
            <ToggleButton active value="web app" onClick={() => setToggle('web app')}>WEB APP'Ss</ToggleButton>
            :
            <ToggleButton value="web app" onClick={() => setToggle('web app')}>WEB APP'Ss</ToggleButton>
          }
          <Divider />
